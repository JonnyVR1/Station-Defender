...
public class ItemFactory {
    ...
    public static Item getItem(Items items) {
        switch (items) {
            case CREDIT:
                return new Item("Credits", 1, 0, 0, 10, 10, true, Items.CREDIT);
            case TURRET:
                return new Item("Weapon", 2, 10, 0, 0, 8, true, Items.TURRET);
            case CLOSE_COMBAT_WEAPON:
                return new Item("Close Combat Weapon", 3, 15, 0, 0, 25, true, Items.CLOSE_COMBAT_WEAPON);
            case RAPID_FIRE_WEAPON:
                return new Item("Rapid Fire Weapon", 4, 15, 0, 0, 13, true, Items.RAPID_FIRE_WEAPON);
            case HEALTH:
                return new Item("Health", 5, 3, 25, 0, 24, true, Items.HEALTH);
            /*case BANDAGES:
                return new Item("Bandages", 6, 3, 5, 0, 26, true, Items.BANDAGES);
            case BRICKS:
                return new Item("Bricks", 7, 5, 0, 0, 28, true, Items.BRICKS);
            case CEMENT:
                return new Item("Cement", 8, 8, 0, 0, 30, true, Items.CEMENT);
            case WATER:
                return new Item("Water", 9, 3, 0, 0, 29, true, Items.WATER);
            case WOOD_BLOCK:
                return new Item("Wooden Blocks", 10, 3, 0, 0, 27, true, Items.WOOD_BLOCK);*/
            default:
                return new Item("Empty", 0, 0, 0, 0, 0, false, Items.UNKNOWN);
        }
    }
